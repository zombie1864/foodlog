...
class WorkoutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create workout" do
    assert_difference('Workout.count') do
      post workouts_url, params: { workout: { calories: @workout.calories, duration: @workout.duration } }
    end
  ...
  test "should update workout" do
    patch workout_url(@workout), params: { workout: { calories: @workout.calories, duration: @workout.duration } }
